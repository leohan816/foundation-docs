...
READ_AND_EXECUTE: ../foundation-docs/advisor/jobs/20260712_agent_office_batch_a_modern_office_identity_completion_001/07E_SENTINEL_DESIGN_FOURTH_DELTA_REREVIEW_HANDOFF_PROMPT.md
RETURN_RESULT_TO: Advisor
DO_NOT_EXECUTE_FROM_MEMORY: true
DO_NOT_BROADEN_SCOPE: true

Open READ_AND_EXECUTE directly. Re-review exact delta 5f8ffd1..381b411 for
U1-U3 closure and regressions. Do not patch or implement. Write/push only the
exact result and pointer, return to Advisor, and STOP.
========
