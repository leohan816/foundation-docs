...
READ_AND_EXECUTE: /home/leo/Project/foundation-docs/advisor/jobs/20260712_agent_office_batch_a_modern_office_identity_completion_001/07P_SENTINEL_IMPLEMENTATION_FIFTH_DELTA_REREVIEW_HANDOFF_PROMPT.md
RETURN_RESULT_TO: Advisor
...
`1e0b550`. Use `/fable-sentinel`. Reapply the prior empty label/roster actual
value and wrong/duplicate roster-trigger attacks to the same predicates; verify
initial-200% exact drawer proof, restored authentic state, and directly affected
