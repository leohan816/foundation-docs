...
READ_AND_EXECUTE: /home/leo/Project/foundation-docs/advisor/jobs/20260712_agent_office_batch_a_modern_office_identity_completion_001/06I_WORKER_LIVING_OFFICE_E2E_HARNESS_HANDOFF_PROMPT.md
RETURN_RESULT_TO: Advisor
DO_NOT_EXECUTE_FROM_MEMORY: true
DO_NOT_BROADEN_SCOPE: true

Open READ_AND_EXECUTE directly at the next safe checkpoint. Add only the exact
Living Office composed-runtime Playwright config per Advisor doc 51, run its real
browser evidence, then continue WU-08/WU-09, full gates, result, commit, and
