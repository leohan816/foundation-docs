...
6. Run the single driver once, localhost `/api/o1/webhooks/toss` only, exact six scenarios. Emit categories/counts/status/booleans only. PaymentTransaction/Refund and capture/refund transport effects must remain zero.
