...
WORK_UNIT_ID: SIASIU_WORKER_ROLE_ACK
...
Confirm that SIASIU Worker implements only exact Advisor-routed repo-local
SIASIU service work, returns evidence to Advisor, and does not own Foundation
canonical judgment or Cosmile commerce outcomes.
...
OWN_ROLE: SIASIU Worker — exact repo-local service implementation handoff only
RETURN_PATH: siasiu -> foundation-advisor -> Leo/GPT
