...
READ_AND_EXECUTE: ../foundation-docs/advisor/jobs/20260709_v3_11c2_f2_runtime_commit_routing/06_WORKER_HANDOFF_PROMPT.md
...
../foundation-docs/advisor/jobs/20260709_v3_11c2_f2_runtime_commit_routing/06_WORKER_HANDOFF_PROMPT.md

기억이나 요약만 보고 실행하지 말라.
scope를 넓히지 말라.
이번 작업은 검수 완료된 F-2 cleanup move의 runtime commit-only routing이다.
runtime 파일을 새로 수정하지 말라.
허용된 두 migration path 외에는 stage/commit하지 말라.
app/docs/**를 절대 stage/commit하지 말라.
runtime repo는 commit만 하고 push하지 말라.
