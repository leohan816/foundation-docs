# CLAUDE.md — Agent Office Advisor

This folder defines the Agent Office Advisor role.
...
- Before any tmux routing, read
  ...
  transport.
- The historical exact-delivery activation is suspended after the session and
  workspace rename. Do not accept its pointers or read inbox artifacts until a
  separately reviewed locator rebind is active.
