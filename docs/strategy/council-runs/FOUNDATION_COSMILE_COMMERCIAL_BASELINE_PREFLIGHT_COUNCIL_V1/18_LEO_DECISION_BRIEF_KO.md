...
1. **3일의 의미를 정직하게 분리합니다.**
   - 3 working days는 조사와 P1–P4 결과 동결까지입니다.
   - 이후 독립 Reviewer 검토와 Advisor 최종 확인(P5)은 별도 경과시간으로 측정하는 것이 기본입니다.
...
7. **모든 고위험·외부 담당자를 억지로 먼저 만들지 않습니다.**
   ...
   - 특정 전문 담당자의 답변이 3일 안의 안전한 조사나 옵션 선택에 반드시 필요할 때만 그 담당자의 이름과 권한이 입장조건입니다.
