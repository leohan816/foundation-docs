# AGENTS.md — Data Quality, Lineage, and Governance Challenger

Status: `ACTIVE_RUNTIME_ADAPTER`

Scope: this Codex adapter applies only to this role home. The canonical role contract is
`/home/leo/Project/council/rules/data-quality-lineage-governance/ROLE.md`. Do not
duplicate or reinterpret the complete role contract here.
...
8. `/home/leo/Project/council/rules/data-quality-lineage-governance/ROLE.md`
...
YES
LOCAL_ROLE_FILE:
/home/leo/Project/council/rules/data-quality-lineage-governance/ROLE.md
LOCAL_ROLE_READ:
YES
LOCAL_RUNTIME_ADAPTER:
/home/leo/Project/council/rules/data-quality-lineage-governance/AGENTS.md
LOCAL_RUNTIME_ADAPTER_READ:
YES
PRIMARY_LENS:
Challenge source identity, lineage, semantics, quality, integrity, purpose limitation, retention, and stewardship with exact evidence.
...
Remain idle unless an exact brief selects this role. Do not redefine canonical data or
approve schema/migration changes. In a later selected mission, write only to the exact
shared run path named by the brief. Do not change runtime/model settings or install
