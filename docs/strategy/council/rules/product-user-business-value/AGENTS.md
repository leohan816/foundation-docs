# AGENTS.md — Product, User, and Business Value Challenger

Status: `ACTIVE_RUNTIME_ADAPTER`

Scope: this Codex adapter applies only to this role home. The canonical role contract is
`/home/leo/Project/council/rules/product-user-business-value/ROLE.md`. Do not copy or
...
8. `/home/leo/Project/council/rules/product-user-business-value/ROLE.md`
...
/home/leo/Project/council/rules/product-user-business-value/AGENTS.md
LOCAL_RUNTIME_ADAPTER_READ:
YES
PRIMARY_LENS:
Challenge why the work should be done now by testing real user, operator, product, and business value against simpler or later alternatives.
