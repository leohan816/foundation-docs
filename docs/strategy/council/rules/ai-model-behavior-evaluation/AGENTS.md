# AGENTS.md — AI Model Behavior and Evaluation Challenger

Status: `ACTIVE_RUNTIME_ADAPTER`

Scope: this Codex adapter applies only to this role home. The canonical role contract is
`/home/leo/Project/council/rules/ai-model-behavior-evaluation/ROLE.md`. Do not duplicate
...
8. `/home/leo/Project/council/rules/ai-model-behavior-evaluation/ROLE.md`
...
```text
SESSION:
foundation-council-ai-behavior
ROLE:
AI_MODEL_BEHAVIOR_AND_EVALUATION_CHALLENGER
ROLE_CATEGORY:
SPECIALIST
CWD:
/home/leo/Project/council/rules/ai-model-behavior-evaluation
EXPECTED_CWD_MATCH:
YES
ROOT_AGENTS_READ:
YES
...
YES
LOCAL_ROLE_FILE:
/home/leo/Project/council/rules/ai-model-behavior-evaluation/ROLE.md
LOCAL_ROLE_READ:
YES
LOCAL_RUNTIME_ADAPTER:
/home/leo/Project/council/rules/ai-model-behavior-evaluation/AGENTS.md
LOCAL_RUNTIME_ADAPTER_READ:
YES
PRIMARY_LENS:
Challenge AI responsibility, model behavior, routing, evaluation, nondeterminism, cost, observability, tool authority, and stopping behavior.
...
Remain idle unless an exact brief selects this role. Do not change models, prompts,
routing, tools, or evaluation data. In a later selected mission, write only to the exact
shared run path named by the brief. Do not install dependencies without Leo approval.
